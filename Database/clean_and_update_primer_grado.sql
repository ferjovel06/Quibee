...
(1, 'Conozcamos los números del 0 al 50', 'Tema 1:\nNúmeros del 0 al 50', 1, 'avares://Quibee/Assets/Images/SmallStar.png', 90, 90, TRUE, NOW(), NOW()),
(1, 'Relacionemos números y objetos', 'Tema 2:\nNúmeros y objetos', 2, 'avares://Quibee/Assets/Images/Moon.png', 95, 95, TRUE, NOW(), NOW()),
(1, 'Comparemos cantidades', 'Tema 3:\nComparemos cantidades', 3, 'avares://Quibee/Assets/Images/LilacPlanet2.png', 90, 90, TRUE, NOW(), NOW()),
(1, 'Suma', 'Tema 4:\nSuma', 4, 'avares://Quibee/Assets/Images/Meteor.png', 85, 85, TRUE, NOW(), NOW()),
(1, 'Resta', 'Tema 5:\nResta', 5, 'avares://Quibee/Assets/Images/Earth2.png', 90, 90, TRUE, NOW(), NOW()),
(1, 'Números cardinales del 1 al 10', 'Tema 6:\nCardinales 1 al 10', 6, 'avares://Quibee/Assets/Images/Saturn2.png', 95, 95, TRUE, NOW(), NOW()),
(1, 'Partes curvas y planas en objetos', 'Tema 7:\nCurvas y planas', 7, 'avares://Quibee/Assets/Images/3.png', 85, 85, TRUE, NOW(), NOW()),
(1, 'Agrupación de objetos por formas', 'Tema 8:\nAgrupación por formas', 8, 'avares://Quibee/Assets/Images/Robot.png', 90, 90, TRUE, NOW(), NOW()),
(1, 'Líneas abiertas y cerradas', 'Tema 9:\nLíneas abiertas/cerradas', 9, 'avares://Quibee/Assets/Images/SmallStar.png', 85, 85, TRUE, NOW(), NOW()),
(1, 'La recta numérica', 'Tema 10:\nLa recta numérica', 10, 'avares://Quibee/Assets/Images/Moon.png', 90, 90, TRUE, NOW(), NOW()),
(1, 'Números del 10 al 50', 'Tema 11:\nNúmeros 10 al 50', 11, 'avares://Quibee/Assets/Images/LilacPlanet2.png', 95, 95, TRUE, NOW(), NOW()),
(1, 'Números del 51 al 100', 'Tema 12:\nNúmeros 51 al 100', 12, 'avares://Quibee/Assets/Images/Meteor.png', 85, 85, TRUE, NOW(), NOW()),
(1, 'Unidades y decenas', 'Tema 13:\nUnidades y decenas', 13, 'avares://Quibee/Assets/Images/Earth2.png', 90, 90, TRUE, NOW(), NOW()),
(1, 'El número 100', 'Tema 14:\nEl número 100', 14, 'avares://Quibee/Assets/Images/Saturn2.png', 95, 95, TRUE, NOW(), NOW()),
(1, 'La recta numérica hasta 100', 'Tema 15:\nRecta hasta 100', 15, 'avares://Quibee/Assets/Images/3.png', 85, 85, TRUE, NOW(), NOW()),
(1, 'Comparación de Números hasta el 100', 'Tema 16:\nComparación hasta 100', 16, 'avares://Quibee/Assets/Images/Robot.png', 90, 90, TRUE, NOW(), NOW()),
(1, 'Comparación de longitudes', 'Tema 17:\nComparación longitudes', 17, 'avares://Quibee/Assets/Images/SmallStar.png', 85, 85, TRUE, NOW(), NOW()),
(1, 'Medimos usando nuestro cuerpo', 'Tema 18:\nMedimos con el cuerpo', 18, 'avares://Quibee/Assets/Images/Moon.png', 90, 90, TRUE, NOW(), NOW()),
(1, 'Lección de repaso', 'Tema 19:\nLección de repaso', 19, 'avares://Quibee/Assets/Images/LilacPlanet2.png', 100, 100, TRUE, NOW(), NOW());

-- Verificar inserción
SELECT COUNT(*) as 'Total Temas Primer Grado' FROM TOPIC WHERE id_level = 1;
SELECT order_index, topic_name FROM TOPIC WHERE id_level = 1 ORDER BY order_index;
